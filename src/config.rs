...
pub const DEFAULT_GRID_ENABLED: bool = true; // Whether the grid overlay is enabled by default
...
pub const DEFAULT_GRID_LETTER_ENABLED: bool = true; // Whether the grid letters is enabled by default
